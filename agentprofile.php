...
if(isset($_POST['delete'])){
    ...
    if($result){
        echo '<script>alert("Agent Account Deleted Successfully!"); 
        window.location.href="agentregistration.php";</script>';  
    } else {
        echo '<script>alert("Agent Account not deleted!")</script>';
    }
}
...
if(isset($_POST['update'])){
    ...
    $update_sql = mysqli_query($con, "UPDATE agents SET agent_name = '$name', address = '$address', phone = '$phone', dob = '$dob', id_no = '$id_no', email = '$email' WHERE id = '$update_id'") or die('query failed');
    echo '<script>alert("Agent details updated!")</script>';
...
<div class="main-container dash-main">
    ...
    <div class="form-container edit-container">
            ...
            <?php
                $select_user = mysqli_query($con, "SELECT * FROM agents WHERE id = '$user_id'") or die('query failed');
                ...
                <div class="field">
                    ...
                    <input type="text" name="name" id="name" placeholder="Name*" value="<?php echo $fetch_user['agent_name']; ?>" required>
                </div>
                ...
                <div class="field">
                 ...
                 <div class="form-btn">
                    <input type="submit" name="update" value="Update Details" class="s-btn" id="s-btn">
                    <a href="agentprofile.php?delete=<?php echo $fetch_user['id']; ?>"><input type="submit" name="delete" value="Delete Account" class="s-btn" id="s-btn"></a>
                 </div>       
