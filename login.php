...
<style>
    ...
    <div class="main-container signup-main">
        <div class="containers col-1">
            <a href="clientlogin.php"><button>User Login</button></a>
            <a href="agentlogin.php"><button>Agent Login</button></a>
            <a href="managerlogin.php"><button>Manager Login</button></a>
        </div>
